-- Gloryfuel Database Schema
-- To be imported into phpMyAdmin (XAMPP)

CREATE DATABASE IF NOT EXISTS gloryfuel_db;
USE gloryfuel_db;
...
('t1', 'Manish', 'FOUNDER & ARCHITECT', 'I started Gloryfuel to make learning both accessible and visually amazing. I handle the UI/UX design and the core architecture basically making sure everything feels premium and works without a hitch.', 'Class 12th (Commerce)', 'Batch: 2026-2027', 'Delhi, India', 'Remote Available', '19 Nov 2008', 'Age: 17 Years', 'GLORYFUEL', 'Creator & Architect', 'https://i.ibb.co/nsWgY8tV/manish.jpg'),
('t2', 'Prince', 'LEAD DEVELOPER', 'I handle the core logic and backend systems. I love writing clean, efficient code and fixing complex bugs to ensure the platform runs fast and smooth for everyone.', 'Class 10th', 'Batch: 2026-2027', 'Bangalore, KA', 'Remote Available', '15 Nov 2009', 'Age: 16 Years', 'GLORYFUEL', 'Lead Developer', 'https://i.ibb.co/v6FKvTf4/prince.jpg')
